...
function FloatingLines({
  ...
  const lineDistanceStr = JSON.stringify(lineDistance);
  ...
  useEffect(() => {
    ...
    const handlePointerMove = event => {
      ...
      targetMouseRef.current.set(relativeX * dpr, (rect.height - relativeY) * dpr);
    ...
    linesGradientStr, enabledWavesStr, lineCountStr, lineDistanceStr,
